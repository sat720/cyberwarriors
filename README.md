...
You should see the ThreatChain dashboard! 🎉
Click any test button to simulate an attack
Watch alerts appear automatically!
🌐 Deployment Guide
...
Create Render Account: Go to render.com and sign up
...
Data persists even after refresh (thanks to MongoDB Atlas!)
🎭 Demo Script for Judges
...
Try clearing data and running test again
Deployment issues
